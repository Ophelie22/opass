...
class AuthService {
  ...
  static async validateUser(email: string, password: string): Promise<Omit<User, 'password'> | null> {
  ...
  static async register(name: string, email: string, password: string) {
      ...
      throw new Error('Échec de linscription : Une erreur inconnue est survenue');
    }
  }
}
